...
bool nullhook::call_kernel_function(void* kernel_function_address)
{
	...
	PVOID* function = reinterpret_cast<PVOID*>(get_system_module_export("\\SystemRoot\\System32\\drivers\\dxgkrnl.sys", "NtGdiDdDDINetDispStopMiracastDisplayDevice"));

	if (!function)
		return false;

	BYTE orig[] = { 0xCE, 0xFF, 0x3F, 0xFD, 0xFC, 0xCD, 0xCC, 0xCC, 0xFD, 0xFE, 0xEF, 0xEE };
